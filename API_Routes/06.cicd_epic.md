...
| **GET**  | `/api/v1/export/yaml`         | Export YAML         |
| **GET**  | `/api/v1/export/pdf`          | Export PDF          |
| **GET**  | `/api/v1/export/markdown`     | Export Markdown     |
| **POST** | `/api/v1/import/json`         | Import JSON         |
| **POST** | `/api/v1/import/csv`          | Import CSV          |
| **POST** | `/api/v1/import/yaml`         | Import YAML         |
| **POST** | `/api/v1/import/zip`          | Import ZIP          |
| **GET**  | `/api/v1/export/full-library` | Export full library |
